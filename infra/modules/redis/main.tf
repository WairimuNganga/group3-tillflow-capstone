...
resource "aws_elasticache_replication_group" "this" {
  ...
  # Access is constrained by private subnets, service security groups, and TLS.
  # Redis AUTH can be added later with a write-only token once the application
  # is ready to supply it at runtime; setting auth_token_update_strategy without
  # a token is rejected by the AWS provider.
